 ...
 <!-- Page Heading -->
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#"><b>Categoria</b></a></li>
                <li class="breadcrumb-item active" aria-current="page">Adicionar Categoria</li>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <a href="<?php echo base_url('categorias')?>" class="btn btn-primary btn-sm float-right"><i class="fas fa-arrow-alt-circle-left"></i>
&nbsp;<b> Voltar</b></a>
                        </div>
                <div class="card-body">
                    ...
                    <form method="post" name="form_edit" class="user">
                      ...
                      <input type="hidden" name="categoria_id" value="<?php echo $categoria->categoria_id?>">
                        ...
                        <legend class='text-sm'> <i class="far fa-copyright"></i>&nbsp;Cadastrar Categoria</legend>

                        <div class="row">

                            <div class="form-group col-md-8">
                              <label for="nome">Nome da Categoria:</label>
                              <input type="text" class="form-control form-control-user" name="categoria_nome" value="<?php echo $categoria->categoria_nome;?>">
                        ...
                        <div class="row p-2">
                            <div class="form-group col-md-12">
                                <button type="submit" class="btn btn-success btn-sm btn-block">Editar Categoria</button>
                            </div>  
                        </div>
                    </form>
                </div>
