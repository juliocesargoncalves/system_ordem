...
&nbsp;<b> Voltar</b></a>
                ...
                <div class="card-body">
                    <form method="post" name="form_add" class="user">
                        ...
                        <legend class='text-sm'> <i class="fas fa-suitcase"></i>&nbsp;Cadastrar Categoria</legend>
                        ...
                        <div class="row p-2">
                            <div class="form-group col-md-12">
                                <button type="submit" class="btn btn-success btn-sm btn-block">Cadastrar Categoria</button>
                            </div>  
                        </div>
                    </form>
                </div>
