    ...
    <?php $this->load->view('layout/navbar')?>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#"><b>Pagamentos</b></a></li>
        ...
        <?php endif;?>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <a href="<?php echo base_url('pagar/add');?>" title="Cadastrar nova Categoria" class="btn btn-success btn-sm float-right"><i class="fas fa-chart-line"></i>&nbsp;<b> Novo</b></a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php foreach($contas_pagar as $value):?>
                                            <tr>
                                                <td class='text-center pr-4'><?php echo $value->conta_pagar_id?></td>
                                                <td class='text-center pr-4'><?php echo $value->fornecedor_nome_fantasia?></td>
                                                <td class='text-center pr-4'><?php echo 'R$ &nbsp;'.$value->conta_pagar_valor?></td>
                                                <td class='text-center pr-4'><?php echo formata_data_banco_sem_hora($value->conta_pagar_data_pagamento);?></td>
                                               
                                                <td class="text-center pr-4"><?php echo ($value->conta_pagar_status == 1 ? formata_data_banco_com_hora($value->conta_pagar_data_pagamento) : '<span class="badge badge-secondary btn-sm">Aguardando Pagamento</span>')?></td>
                                                <td class="text-center pr-4">
                                                
                                                    <?php 

                                                        if($value->conta_pagar_status == 1){

                                                            echo "<span class='badge badge-success btn-sm'>Paga</span>";

                                                        } else if(strtotime($value->conta_pagar_data_vencimento) > strtotime(date('Y-m-d'))){

                                                            echo "<span class='badge badge-info btn-sm'>A pagar</span>";
                                            ...
                                            <td class="text-right">
                                                    <a title="Editar" href="<?php echo base_url('pagar/edit/'.$value->conta_pagar_id);?>" class="btn btn-primary btn-circle btn-sm">
                                                    <i class="fas fa-chart-line"></i>
                                                    </a>
                                                    <a title="Excluir" href="javascript(void);" class="btn btn-danger btn-circle btn-sm" data-toggle="modal" data-target="#user-<?php echo $value->conta_pagar_id;?>"> 
                                                    <i class="fas fa-chart-line"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                            ...
                                            <!-- Logout Modal-->
                                                  <!-- <div class="modal fade" id="user-<?php echo $value->conta_pagar_id?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog  modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a class="btn btn-danger btn-sm" href="<?php echo base_url('pagar/remove/').$value->conta_pagar_id;?>">Sim</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
