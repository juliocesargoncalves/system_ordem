    ...
    <?php $this->load->view('layout/navbar')?>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#"><b>Usuários</b></a></li>
        ...
        <?php endif;?>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <a href="<?php echo base_url('usuarios/add');?>" title="Cadastrar novo Usuário" class="btn btn-success btn-sm float-right"><i class="fas fa-user-plus"></i>&nbsp;<b> Novo</b></a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-right no-sort pr-1">Ações</th>
                                    ...
                                    <tbody>
                                        <?php foreach($usuarios as $user):?>
                                            <tr>
                                                ...
                                                <td class="text-center pr-4" ><?php echo ($user->active == 1 ? '<span class="badge badge-success btn-sm">Ativo</span>' : '<span class="badge badge-danger btn-sm">Inativo</span>')?></td>
                                                <td class="text-right">
                                                    <a title="Editar" href="<?php echo base_url('usuarios/edit/'.$user->id);?>" class="btn btn-primary btn-circle btn-sm">
                                                        <i class="fas fa-user-edit"></i>
                                                    </a>
                                                    <a title="Excluir" href="javascript(void);" class="btn btn-danger btn-circle btn-sm" data-toggle="modal" data-target="#user-<?php echo $user->id?>"> 
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title text-center" id="exampleModalLabel">Tem certeza que deseja remover esse usuario ?</h5>
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a class="btn btn-danger btn-sm" href="<?php echo base_url('usuarios/remove/').$user->id;?>">Sim</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
